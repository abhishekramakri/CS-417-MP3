...
namespace MobileVRInventory
{
    ...
    {        
        ...
        void Awake()
        {            
            exampleController = Object.FindAnyObjectByType<VRInventoryExampleSceneController>();
            gazeInputModuleInventory = Object.FindAnyObjectByType<GazeInputModuleInventory>();
        }
